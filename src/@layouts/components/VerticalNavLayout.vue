...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const filteredNavItems = () => {
      return props.navItems.filter(navItem => {
        if (navItem.subject === 'all')
          return navItem
    ...
    return () => {
      ...
      // 👉 Vertical nav
      let verticalNav = h('div')
      verticalNav = h(
        VerticalNav,
        { isOverlayNavActive: isOverlayNavActive.value, toggleIsOverlayNavActive, navItems: filteredNavItems(), ...additionalVerticalNavAttrs },
        {
